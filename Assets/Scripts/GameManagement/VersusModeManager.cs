...
public class VersusModeManager : MonoBehaviour
{
    ...
    public GameObject dividerPanel; // Black divider panel in the middle (assign in inspector)
    ...
    public void EnableVersusMode()
    {
        ...
        // Show divider panel
        if (dividerPanel != null)
        {
            dividerPanel.SetActive(true);
            Debug.Log("VersusModeManager: Divider panel activated");
        }
        else
        {
            // Fallback: find by name if not assigned
            dividerPanel = GameObject.Find("VersusDivider");
            if (dividerPanel != null)
            {
                dividerPanel.SetActive(true);
                Debug.Log("VersusModeManager: Found and activated VersusDivider by name");
            }
        }
